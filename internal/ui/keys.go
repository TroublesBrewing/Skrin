...
var defaultBindings = []binding{
	...
	{actSelDown, []string{"J"}, "grow the selection down a line (shift+↓ too)", groupNote, inMain},
	{actSelUp, []string{"K"}, "grow the selection up a line (shift+↑ too)", groupNote, inMain},
	...
	{actPins, []string{"P"}, "the notes you have pinned", groupSearch, inMain},
	{actTags, []string{"#"}, "every tag in the vault, with how often it is used", groupSearch, inMain},
	...
	{actNextField, []string{"down", "tab"}, "columns → rows → headings", groupTable, inTable},
	{actPrevField, []string{"up", "shift+tab"}, "the field before", groupTable, inTable},
	{actRight, []string{"right"}, "columns, rows: one more", groupTable, inTable},
	{actLeft, []string{"left"}, "columns, rows: one fewer", groupTable, inTable},
