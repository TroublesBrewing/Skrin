...
var mainCommands = []paletteEntry{
	...
	{actExtract, "Pull the selection into its own note", "extract refactor split new"},
...
var editorCommands = []editorCommand{
	...
	{act: actExtract, name: "Pull the selection into its own note", also: "extract refactor split new"},
